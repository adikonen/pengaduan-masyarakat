...
<html lang="en">
  <head>
    ...
    <title>Portal Pengaduan | Login</title>
                  ...
                  <div class="p-5">
                    ...
                    <form class="user" action="<?= BASE_URL?>/auth/authenticate" method="POST">
                      <div class="form-group">
                        <hr />
                        <input type="username" name="username" class="form-control form-control-user" id="exampleInputusername" aria-describedby="usernameHelp" placeholder="Enter Username..." />
                      </div>
                      <div class="form-group">
                        <hr />
